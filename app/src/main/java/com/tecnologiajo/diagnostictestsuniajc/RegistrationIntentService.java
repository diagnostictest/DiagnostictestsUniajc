...
public class RegistrationIntentService extends IntentService  {
    ...
    private void registerProcess(String name,String registrationId){
        App42API.buildPushNotificationService().storeDeviceToken(name,registrationId,new App42CallBack() {
