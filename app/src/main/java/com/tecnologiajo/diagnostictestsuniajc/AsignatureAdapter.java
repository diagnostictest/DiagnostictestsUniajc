 ...
 */
public class AsignatureAdapter extends ArrayAdapter<Asignatura> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Asignatura asignatura = getItem(position);

        final Drawable drawable = asignatura.getDrawable();
        viewHolder.imageView.setImageDrawable(drawable);
        viewHolder.textView.setText(asignatura.getDescripcion());
